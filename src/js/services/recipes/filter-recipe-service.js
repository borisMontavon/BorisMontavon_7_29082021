...
const updateFiltersLists = () => {
    ...
    store.ingredientDropdown.state.filterComponents.forEach((filterComponent) => {
        filterComponent.state.isInDisplayedRecipe = store.recipeComponents
            .some((recipeComponent) => recipeComponent.state.displayed && recipeComponent.state.ingredientsMatch.includes(filterComponent.state.titleMatch));
    });
    ...
    store.machineDropdown.state.filterComponents.forEach((filterComponent) => {
        filterComponent.state.isInDisplayedRecipe = store.recipeComponents
            .some((recipeComponent) => recipeComponent.state.displayed && recipeComponent.state.applianceMatch === filterComponent.state.titleMatch);
    });
    ...
    store.ustensilDropdown.state.filterComponents.forEach((filterComponent) => {
        filterComponent.state.isInDisplayedRecipe = store.recipeComponents
            .some((recipeComponent) => recipeComponent.state.displayed && recipeComponent.state.ustensilsMatch.includes(filterComponent.state.titleMatch));
    });
